...
import { isOpus1mMergeEnabled, renderDefaultModelSetting } from '../../utils/model/model.js';
...
export const call: LocalJSXCommandCall = async (onDone, _context, args) => {
  ...
  if (COMMON_HELP_ARGS.includes(args)) {
    onDone('Run /model to open the model selection menu, or /model [modelName] to set any OpenRouter model.', {
      display: 'system'
    });
    return;
  }
...
function renderModelLabel(model: string | null): string {
  ...
  const rendered = renderDefaultModelSetting(model);
  return rendered;
}
