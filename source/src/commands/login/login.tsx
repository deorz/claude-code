...
import { OpenRouterApiKeyPrompt } from '../../components/OpenRouterApiKeyPrompt.js';
...
import { isOpenRouterCompatibleEndpoint } from '../../utils/model/providers.js';
...
export function Login(props: {
  ...
  const existingOpenRouterApiKey = getAnthropicApiKeyWithSource().key ?? ''

  if (openRouterCompatibleEndpoint) {
    return (
      <OpenRouterApiKeyPrompt
        initialValue={existingOpenRouterApiKey}
        onDone={success => props.onDone(success, mainLoopModel)}
      />
    )
  }
